        ...
        methods: {
        	handlePick() {
        		if(this.departments.length) {
                    ...
                    this.$xhr.getData('department/getDepartmentInfo')
                    .then((departments) => {
            ...
            handleSubmit() {
                ...
                .then(() => {
                    this.$toast.show('注册成功，等待审核');
                    this.$lazyroute.replace('/login'); 
                })
            },
            verification() {
                if(this.phone == '') {
