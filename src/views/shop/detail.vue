    ...
    export default {
        ...
        methods: {
            handleSubmit: async function() {
                ...
                this.$xhr.handle('goods/exchangeGoods', {
                ...
                .then((userInfo) => {
                    this.$toast.show('兑换成功，扣除点券' + this.list.point);
                    this.$lazyroute.replace('/user/exchange');
                });
            }
        },
        route: {
            data: async function(transition) {
                await this.$xhr.getUserInfo();
                return this.$xhr.getData('goods/getGoodsDetails', {
